...
public class MyTaskedDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mytaskeddetail);
        initView();
    }

    private void initView() {
        tv_taskeddiscuss = (TextView)findViewById(R.id.tv_taskeddiscuss);
        ...
        tv_taskeddiscuss.setText(intent.getStringExtra("tcomment"));
        ...
        new DownImageAsyncTask().execute(json);
    }

    class DownImageAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            mContext = MyTaskedDetailActivity.this;
