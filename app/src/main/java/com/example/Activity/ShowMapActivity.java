...
public class ShowMapActivity extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener,
    ...
    public void searchButtonProcess(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.go_walk:
                ...
                break;
            case R.id.go_end:
                Intent intent = new Intent(ShowMapActivity.this,TaskActivity.class);
                intent.putExtra("task_location",task_location);
                intent.putExtra("tlatitude",String.valueOf(endPt.latitude));
                intent.putExtra("tlongitude",String.valueOf(endPt.longitude));
                Log.d("taskActivity", "endPt.longitude: " + endPt.longitude);
                Log.d("taskActivity", "endPt.latitude: " + endPt.latitude);
    ...
    public void MyToast(String s) {
        Toast.makeText(ShowMapActivity.this, s, Toast.LENGTH_SHORT).show();
    }
