...
public class PatrolResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patrolresult);
        initView();
    }
    ...
    private void initView() {
        ...
        list_taskpatroled.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Intent intent = new Intent(PatrolResultActivity.this, PatrolDetailActivity.class);
    ...
    class DownPatroledAsyncTask extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            mContext = PatrolResultActivity.this;
