...
public class PatrolMapActivity extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener,
    ...
    public void MyToast(String s) {
        Toast.makeText(PatrolMapActivity.this, s, Toast.LENGTH_SHORT).show();
    }
