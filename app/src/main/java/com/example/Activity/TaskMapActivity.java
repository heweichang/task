...
import com.example.BaiduMap.overlayutil.BikingRouteOverlay;
import com.example.BaiduMap.overlayutil.DrivingRouteOverlay;
import com.example.BaiduMap.overlayutil.OverlayManager;
import com.example.BaiduMap.overlayutil.PoiOverlay;
import com.example.BaiduMap.overlayutil.TransitRouteOverlay;
import com.example.BaiduMap.overlayutil.WalkingRouteOverlay;

public class TaskMapActivity extends Activity implements BaiduMap.OnMapClickListener, OnGetRoutePlanResultListener,
        View.OnClickListener, OnGetSuggestionResultListener, OnGetPoiSearchResultListener, AdapterView.OnItemClickListener {
    // 浏览路线节点相关
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_taskmap);
        // 初始化控件
        initview();
        // 初始化地图
        inintmap();
        ...
        mBaidumap.setOnMapClickListener(new BaiduMap.OnMapClickListener() {
            ...
            public boolean onMapPoiClick(MapPoi arg0) {
                ...
                task_location = arg0.getName();
                endPt = arg0.getPosition();

                mBaidumap.clear();
                LatLng lg_task  = new LatLng(Double.parseDouble(tlatitude),Double.parseDouble(tlongitude));
                mydraw(lg_task, R.drawable.icon_en);
                return false;
            }
    ...
    public void initview() {
        Intent mytaskintent = getIntent();
        tlatitude = mytaskintent.getStringExtra("tlatitude");
        tlongitude = mytaskintent.getStringExtra("tlongitude");
        Log.d("taskActivity", "endPt.longitude: " + tlatitude);
        Log.d("taskActivity", "endPt.longitude: " + tlongitude);
        ...
        keyWorldsView.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence cs, int arg1, int arg2, int arg3) {
                 ...
                 */
                mSuggestionSearch.requestSuggestion((new SuggestionSearchOption()).keyword(cs.toString()).city(localcity));
            }
        });
        ...
        end_edit.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                 ...
                 * 使用建议搜索服务获取建议列表，结果在onSuggestionResult()中更新
                 */
                mSuggestionSearch.requestSuggestion((new SuggestionSearchOption()).keyword(s.toString()).city(localcity));
    ...
    public void MyToast(String s) {
        Toast.makeText(TaskMapActivity.this, s, Toast.LENGTH_SHORT).show();
    }
