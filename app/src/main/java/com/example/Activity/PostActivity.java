...
import com.example.tools.RemindOther;
...
/**
 * Created by 何伟昌 on 2018/6/24.
 */
public class PostActivity extends AppCompatActivity implements ImagePickerAdapter.OnRecyclerViewItemClickListener{
    public static final int IMAGE_ITEM_ADD = -1;
    public static final int REQUEST_CODE_SELECT = 100;
    public static final int REQUEST_CODE_PREVIEW = 101;

    private EditText et_bj,et_biaoti;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        et_bj = (EditText)findViewById(R.id.et_bj);
        btn_slect = (Button)findViewById(R.id.btn_post);
    ...
    private String url= Constant.BASE_URL+"/Topicadd.do";
    ...
    private void uploadImage(ArrayList<ImageItem> pathList) {
        ...
        String topicid = FileTime2.replace(":", "");
        userid = SharedPreferencesUtils.getParam(PostActivity.this, "iduser", "").toString();
        httpUtil.postPostRequest(url, et_biaoti.getText().toString(), et_bj.getText().toString(), userid,topicid,pathList,mContext, new MyStringCallBack() {
            ...
            public void onResponse(String response, int id) {
                ...
                String userpri = SharedPreferencesUtils.getParam(PostActivity.this, "privilege", "").toString();
                if(userpri.equals("1")) {
                    RemindOther.getWebSocketClient().send("论坛有新公告！");
                }
                //返回图片的地址
            }
        });
