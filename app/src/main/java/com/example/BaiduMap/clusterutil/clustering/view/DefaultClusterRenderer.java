...
public class DefaultClusterRenderer<T extends ClusterItem>
		implements com.example.BaiduMap.clusterutil.clustering.view.ClusterRenderer<T> {
	...
	private com.example.BaiduMap.clusterutil.ui.SquareTextView makeSquareTextView(Context context) {
		com.example.BaiduMap.clusterutil.ui.SquareTextView squareTextView = new com.example.BaiduMap.clusterutil.ui.SquareTextView(context);
